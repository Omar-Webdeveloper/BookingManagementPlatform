...
- Create Angular project with ng: `ng new bookingmanagementplatform.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bookingmanagementplatform.client.esproj`).
